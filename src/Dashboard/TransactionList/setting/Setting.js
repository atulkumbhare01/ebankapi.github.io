...
export const Setting = () => {
 ...
 <button type="button" class="btn btn-primary Single"  target="1">Change Password</button>
<Link to="/user-api"><button type="button" class="btn btn-success Single" target="2">API</button></Link>
        ...
        <div id="div1" class="target">
	             ...
	             <div id="div2"class="target"style={{display:"none"}}>
                  <form class="oldpass" >
                   <div class="form-group ">
				       <h4><b>API Key</b></h4>
                        <label class="form-label">Here is your API Key</label>
                        <input type="text" class="form-control" placeholder="Enter API"/>
                          <div class="clearfix"></div>
                            </div>
                              <div class="text-center">
